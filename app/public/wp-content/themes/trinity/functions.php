...
if ( ! function_exists( 'trinity_setup' ) ) {
	...
	function trinity_setup() {
		...
		if ( 127 > Trinity_Custom_Colors::get_relative_luminance_from_hex( $background_color ) ) {
		...
		add_theme_support(
			...
			array(
				array(
					'name'      => esc_html__( 'Extra small', 'trinity' ),
					'shortName' => esc_html_x( 'XS', 'Font size', 'trinity' ),
					'size'      => 16,
					'slug'      => 'extra-small',
				),
				array(
					'name'      => esc_html__( 'Small', 'trinity' ),
					'shortName' => esc_html_x( 'S', 'Font size', 'trinity' ),
					'size'      => 18,
					'slug'      => 'small',
				),
				array(
					'name'      => esc_html__( 'Normal', 'trinity' ),
					'shortName' => esc_html_x( 'M', 'Font size', 'trinity' ),
					'size'      => 20,
					'slug'      => 'normal',
				),
				array(
					'name'      => esc_html__( 'Large', 'trinity' ),
					'shortName' => esc_html_x( 'L', 'Font size', 'trinity' ),
					'size'      => 24,
					'slug'      => 'large',
				),
				array(
					'name'      => esc_html__( 'Extra large', 'trinity' ),
					'shortName' => esc_html_x( 'XL', 'Font size', 'trinity' ),
					'size'      => 40,
					'slug'      => 'extra-large',
				),
				array(
					'name'      => esc_html__( 'Huge', 'trinity' ),
					'shortName' => esc_html_x( 'XXL', 'Font size', 'trinity' ),
					'size'      => 96,
					'slug'      => 'huge',
				),
				array(
					'name'      => esc_html__( 'Gigantic', 'trinity' ),
					'shortName' => esc_html_x( 'XXXL', 'Font size', 'trinity' ),
					'size'      => 144,
					'slug'      => 'gigantic',
				),
			)
		...
		add_theme_support(
			...
			array(
				array(
					'name'  => esc_html__( 'Black', 'trinity' ),
					'slug'  => 'black',
					'color' => $black,
				),
				array(
					'name'  => esc_html__( 'Dark gray', 'trinity' ),
					'slug'  => 'dark-gray',
					'color' => $dark_gray,
				),
				array(
					'name'  => esc_html__( 'Gray', 'trinity' ),
					'slug'  => 'gray',
					'color' => $gray,
				),
				array(
					'name'  => esc_html__( 'Green', 'trinity' ),
					'slug'  => 'green',
					'color' => $green,
				),
				array(
					'name'  => esc_html__( 'Blue', 'trinity' ),
					'slug'  => 'blue',
					'color' => $blue,
				),
				array(
					'name'  => esc_html__( 'Purple', 'trinity' ),
					'slug'  => 'purple',
					'color' => $purple,
				),
				array(
					'name'  => esc_html__( 'Red', 'trinity' ),
					'slug'  => 'red',
					'color' => $red,
				),
				array(
					'name'  => esc_html__( 'Orange', 'trinity' ),
					'slug'  => 'orange',
					'color' => $orange,
				),
				array(
					'name'  => esc_html__( 'Yellow', 'trinity' ),
					'slug'  => 'yellow',
					'color' => $yellow,
				),
				array(
					'name'  => esc_html__( 'White', 'trinity' ),
					'slug'  => 'white',
					'color' => $white,
				),
			)
		...
		add_theme_support(
			...
			array(
				array(
					'name'     => esc_html__( 'Purple to yellow', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $purple . ' 0%, ' . $yellow . ' 100%)',
					'slug'     => 'purple-to-yellow',
				),
				array(
					'name'     => esc_html__( 'Yellow to purple', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $yellow . ' 0%, ' . $purple . ' 100%)',
					'slug'     => 'yellow-to-purple',
				),
				array(
					'name'     => esc_html__( 'Green to yellow', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $green . ' 0%, ' . $yellow . ' 100%)',
					'slug'     => 'green-to-yellow',
				),
				array(
					'name'     => esc_html__( 'Yellow to green', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $yellow . ' 0%, ' . $green . ' 100%)',
					'slug'     => 'yellow-to-green',
				),
				array(
					'name'     => esc_html__( 'Red to yellow', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $red . ' 0%, ' . $yellow . ' 100%)',
					'slug'     => 'red-to-yellow',
				),
				array(
					'name'     => esc_html__( 'Yellow to red', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $yellow . ' 0%, ' . $red . ' 100%)',
					'slug'     => 'yellow-to-red',
				),
				array(
					'name'     => esc_html__( 'Purple to red', 'trinity' ),
					'gradient' => 'linear-gradient(160deg, ' . $purple . ' 0%, ' . $red . ' 100%)',
					'slug'     => 'purple-to-red',
				),
				array(
					'name'     => esc_html__( 'Red to purple', 'trinity' ),
		...
		*/
		if ( is_customize_preview() ) {
			...
			add_theme_support( 'starter-content', trinity_get_starter_content() );
		}
